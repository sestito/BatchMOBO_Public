...
from pyMOBOS.acquisition import qEHVI
...
from pyMOBOS.qualitytests import Test_BoTorch as Test
...
test_functions = [
    ZDT1(number_of_parameters = 3),
    ZDT2(number_of_parameters = 3),
    ZDT3(number_of_parameters = 3),
    FON(number_of_parameters = 3),
    DTLZ2(number_of_parameters = 4, number_of_objectives = 3),
    DTLZ2(number_of_parameters = 5, number_of_objectives = 4),
    DTLZ2(number_of_parameters = 6, number_of_objectives = 5)
    ]

test_methods = [
    Test(qEHVI, name = "qEHVI", batch_size = 3)
    ]
